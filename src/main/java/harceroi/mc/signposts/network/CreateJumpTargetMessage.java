...
public class CreateJumpTargetMessage implements IMessage{
  ...
  public CreateJumpTargetMessage(int signX, int signY, int signZ, double jumpX, double jumpY, double jumpZ, String label) {
    super();
    this.signX = signX;
    this.signY = signY;
    this.signZ = signZ;
  ...
  // public void addSignPost(int signX, int signY, int signZ, double jumpX, double jumpY, double jumpZ, String label, World world)

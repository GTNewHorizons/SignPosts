...
public class ClientProxy extends CommonProxy {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        ResourceLocation signPostMarkerTextureLocation = new ResourceLocation(
            SignPostsMod.ID + ":textures/gui/markers/signPost.png");
        AtlasAPI.getMarkerAPI()
            .setTexture("signPost", signPostMarkerTextureLocation);
    ...
    public void openAtlasGui(ItemStack stack, String paymentHandlerKey) {
        ...
        if (mc.currentScreen == null) {
            mc.displayGuiScreen(
                atlasGui.setAtlasItemStack(stack)
                    .setPaymentHandlerKey(paymentHandlerKey));
        }
    }
